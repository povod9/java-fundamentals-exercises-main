...
public class Functions {
    ...
    public static FunctionMap<Integer, Integer> intFunctionMap() {
        ...
        intFunctionMap.addFunction("abs", Math::abs); // method reference
        intFunctionMap.addFunction("increment", Math::incrementExact); // method reference
        intFunctionMap.addFunction("decrement", s -> Math.decrementExact(s)); // lambda
        intFunctionMap.addFunction("square", x -> x * x);
        intFunctionMap.addFunction("sgn", s -> Integer.signum(s));
