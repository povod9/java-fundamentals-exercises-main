...
public class CrazyLambdas {
    ...
    public static Supplier<String> helloSupplier() {
        // By Anonymous Class
//        Supplier<String> hello = new Supplier<String>() {
//            @Override
//            public String get() {
//                return "Hello";
//            }
...
//        return hello;
    ...
    public static Predicate<String> isEmptyPredicate() {
        // Anonymous Class
//        Predicate<String> isEmpString = new Predicate<String>() {
//            @Override
...
//        return isEmpString;
        ...
        //          Lambda
//        Predicate<String> isEmpString = result -> result.isEmpty();
//        return isEmpString;
...
//        BiFunction<String, Integer, String> repString = new BiFunction<String, Integer, String>() {
//            @Override
...
//        return repString;
        ...
        // Lambda
//        BiFunction<String, Integer, String> repString = (s, n) -> s.repeat(n);
//        return repString;
    ...
    public static Function<BigDecimal, String> toDollarStringFunction() {
        ...
        //Anonymous class
        //        Function<BigDecimal, String> result = new Function<BigDecimal, String>() {
//            @Override
...
//        return result;
    ...
    public static Predicate<String> lengthInRangePredicate(int min, int max) {
        Predicate<String> result = s -> s.length() >= min && s.length() < max;
        return result;
    }
    ...
    public static IntSupplier randomIntSupplier() {
        ...
        //Method Reference
//        IntSupplier result = random::nextInt;
        // Lambda
        IntSupplier result = () -> random.nextInt();
        return result;
    }
    ...
    public static IntUnaryOperator boundedRandomIntSupplier() {
        ...
        IntUnaryOperator result = o -> random.nextInt();
        return result;
    }
    ...
    public static Supplier<IntUnaryOperator> nMultiplyFunctionSupplier(int n) {
        Supplier<IntUnaryOperator> result = () -> (operand) ->  operand * n;
        return result;
    }
...
//        BiFunction<IntUnaryOperator, IntPredicate, IntUnaryOperator> result =
//                (intUnaryOperator, intPredicate) ->  operand -> intUnaryOperator.applyAsInt(operand);
//        return result;
...
//        BiFunction<Map<String, IntUnaryOperator>, String, IntUnaryOperator> result =
//                ((stringIntUnaryOperatorMap, s) -> stringIntUnaryOperatorMap.get(s));
//        return result;
        // Not Completed
        throw new ExerciseNotCompletedException();
    }
